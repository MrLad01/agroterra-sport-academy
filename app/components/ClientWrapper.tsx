...
export default function ClientWrapper({ children }: ClientWrapperProps) {
    ...
    const [toggleTheme] = useState(false);  

  return (
    <ThemeProvider>
        <div className={` relative ${
            toggleTheme ? "bg-slate-900 text-emerald-100" : "bg-gray-50 text-slate-900"
        ...
        <SidebarComponent />
            ...
            className={`py-16 px-4 sm:px-6 lg:px-8 ${
                toggleTheme ? "bg-slate-900/80 border-t border-emerald-500/30" : "bg-emerald-50 border-t border-emerald-200/50"
            } relative z-10`}
            >
